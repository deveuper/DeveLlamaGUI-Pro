...
<p align="center">
<img src="1.gif" width="360" alt="启动与使用">
<img src="2.gif" width="360" alt="内存占用">
</p>

> 🎬 **启动与使用** — 选择模型 → 配置参数 → 一键启动 → 实时对话 | **极低内存占用** — GUI 本体仅 ~35MB

<p align="center">
<img src="3.gif" width="360" alt="主题与语言">
<img src="4.gif" width="360" alt="思考模式">
</p>

> 🎨 **6种主题 × 5种语言** — Cyberpunk、Sakura Pink 等一键切换 | 🧠 **一键关闭思考模式** — Qwen3/3.5、DeepSeek 等
...
<p align="center">
<img src="1.gif" width="360" alt="Launch & Usage">
<img src="2.gif" width="360" alt="Low Memory">
</p>

> 🎬 **Launch & Usage** — Select model → Configure params → One-click start → Real-time chat | **Tiny Memory Footprint** — GUI itself uses only ~35MB

<p align="center">
<img src="3.gif" width="360" alt="Themes & Languages">
<img src="4.gif" width="360" alt="Thinking Mode">
</p>

> 🎨 **6 Themes × 5 Languages** — Switch between Cyberpunk, Sakura Pink and more instantly | 🧠 **One-Click Thinking Toggle** — Qwen3/3.5, DeepSeek and more
...
<p align="center">
<img src="1.gif" width="360" alt="啟動與使用">
<img src="2.gif" width="360" alt="記憶體佔用">
</p>

> 🎬 **啟動與使用** — 選擇模型 → 配置參數 → 一鍵啟動 → 即時對話 | **極低記憶體佔用** — GUI 本體僅 ~35MB

<p align="center">
<img src="3.gif" width="360" alt="主題與語言">
<img src="4.gif" width="360" alt="思考模式">
</p>

> 🎨 **6種主題 × 5種語言** — Cyberpunk、Sakura Pink 等一鍵切換 | 🧠 **一鍵關閉思考模式** — Qwen3/3.5、DeepSeek 等
...
<p align="center">
<img src="1.gif" width="360" alt="起動と使用">
<img src="2.gif" width="360" alt="メモリ使用量">
</p>

> 🎬 **起動と使用** — モデル選択 → パラメータ設定 → ワンクリック起動 → リアルタイム対話 | **超低メモリ** — GUI自体わずか~35MB

<p align="center">
<img src="3.gif" width="360" alt="テーマと言語">
<img src="4.gif" width="360" alt="思考モード">
</p>

> 🎨 **6テーマ × 5言語** — Cyberpunk、Sakura Pinkなどをワンクリック切替 | 🧠 **思考モード切替** — Qwen3/3.5、DeepSeekなど
...
<p align="center">
<img src="1.gif" width="360" alt="시작 및 사용">
<img src="2.gif" width="360" alt="메모리 사용량">
</p>

> 🎬 **시작 및 사용** — 모델 선택 → 매개변수 설정 → 원클릭 시작 → 실시간 대화 | **초저메모리** — GUI 자체 ~35MB

<p align="center">
<img src="3.gif" width="360" alt="테마 및 언어">
<img src="4.gif" width="360" alt="사고 모드">
</p>

> 🎨 **6개 테마 × 5개 언어** — Cyberpunk, Sakura Pink 등 원클릭 전환 | 🧠 **사고 모드 전환** — Qwen3/3.5, DeepSeek 등
