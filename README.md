...
[English](#-devellamagui-pro) | [简体中文](#-devllamagui-pro-1) | [繁體中文](#-devllamagui-pro-2) | [日本語](#-devllamagui-pro-3) | [한국어](#-devllamagui-pro-4)
...
1. **Download** the latest release from [Releases](https://github.com/user/DeveLlamaGUI-Pro/releases)
...
```bash
git clone https://github.com/user/DeveLlamaGUI-Pro.git
cd DeveLlamaGUI-Pro
cargo build --release
```
