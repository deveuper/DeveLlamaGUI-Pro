...
<img src="1.gif" width="100%" alt="启动与使用"><br>
<b>启动与使用</b><br>
<sub>选择模型 → 配置参数 → 一键启动 → 实时对话</sub>
</td>
<td width="50%" align="center">
<img src="2.gif" width="100%" alt="内存占用"><br>
<b>极低内存占用</b><br>
<sub>GUI 本体仅 ~35MB，远低于 LM Studio 的 1GB+</sub>
</td>
</tr>
<tr>
<td width="50%" align="center">
<img src="3.gif" width="100%" alt="主题与语言"><br>
<b>6种主题 × 5种语言</b><br>
<sub>Cyberpunk、Sakura Pink 等主题一键切换</sub>
</td>
<td width="50%" align="center">
<img src="4.gif" width="100%" alt="思考模式"><br>
<b>一键关闭思考模式</b><br>
<sub>支持 Qwen3/3.5、DeepSeek 等推理模型的思考开关</sub>
</td>
</tr>
</table>
...
<tr>
<td width="50%" align="center">
<img src="1.gif" width="100%" alt="Launch & Usage"><br>
<b>Launch & Usage</b><br>
<sub>Select model → Configure params → One-click start → Real-time chat</sub>
</td>
<td width="50%" align="center">
<img src="2.gif" width="100%" alt="Low Memory"><br>
<b>Tiny Memory Footprint</b><br>
<sub>GUI itself uses only ~35MB, far less than LM Studio's 1GB+</sub>
</td>
</tr>
<tr>
<td width="50%" align="center">
<img src="3.gif" width="100%" alt="Themes & Languages"><br>
<b>6 Themes × 5 Languages</b><br>
<sub>Switch between Cyberpunk, Sakura Pink and more instantly</sub>
</td>
<td width="50%" align="center">
<img src="4.gif" width="100%" alt="Thinking Mode"><br>
<b>One-Click Thinking Toggle</b><br>
<sub>Turn thinking mode on/off for Qwen3/3.5, DeepSeek and more</sub>
</td>
</tr>
</table>
...
<tr>
<td width="50%" align="center">
<img src="1.gif" width="100%" alt="啟動與使用"><br>
<b>啟動與使用</b><br>
<sub>選擇模型 → 配置參數 → 一鍵啟動 → 即時對話</sub>
</td>
<td width="50%" align="center">
<img src="2.gif" width="100%" alt="記憶體佔用"><br>
<b>極低記憶體佔用</b><br>
<sub>GUI 本體僅 ~35MB，遠低於 LM Studio 的 1GB+</sub>
</td>
</tr>
<tr>
<td width="50%" align="center">
<img src="3.gif" width="100%" alt="主題與語言"><br>
<b>6種主題 × 5種語言</b><br>
<sub>Cyberpunk、Sakura Pink 等主題一鍵切換</sub>
</td>
<td width="50%" align="center">
<img src="4.gif" width="100%" alt="思考模式"><br>
<b>一鍵關閉思考模式</b><br>
<sub>支援 Qwen3/3.5、DeepSeek 等推理模型的思考開關</sub>
</td>
</tr>
</table>
...
<tr>
<td width="50%" align="center">
<img src="1.gif" width="100%" alt="起動と使用"><br>
<b>起動と使用</b><br>
<sub>モデル選択 → パラメータ設定 → ワンクリック起動 → リアルタイム対話</sub>
</td>
<td width="50%" align="center">
<img src="2.gif" width="100%" alt="メモリ使用量"><br>
<b>超低メモリ使用量</b><br>
<sub>GUI自体はわずか~35MB、LM Studioの1GB+よりはるかに少ない</sub>
</td>
</tr>
<tr>
<td width="50%" align="center">
<img src="3.gif" width="100%" alt="テーマと言語"><br>
<b>6テーマ × 5言語</b><br>
<sub>Cyberpunk、Sakura Pinkなどのテーマをワンクリックで切替</sub>
</td>
<td width="50%" align="center">
<img src="4.gif" width="100%" alt="思考モード"><br>
<b>ワンクリック思考モード切替</b><br>
<sub>Qwen3/3.5、DeepSeekなど推論モデルの思考ON/OFFに対応</sub>
</td>
</tr>
</table>
...
<tr>
<td width="50%" align="center">
<img src="1.gif" width="100%" alt="시작 및 사용"><br>
<b>시작 및 사용</b><br>
<sub>모델 선택 → 매개변수 설정 → 원클릭 시작 → 실시간 대화</sub>
</td>
<td width="50%" align="center">
<img src="2.gif" width="100%" alt="메모리 사용량"><br>
<b>초저메모리 사용량</b><br>
<sub>GUI 자체는 ~35MB만 사용, LM Studio의 1GB+보다 훨씬 적음</sub>
</td>
</tr>
<tr>
<td width="50%" align="center">
<img src="3.gif" width="100%" alt="테마 및 언어"><br>
<b>6개 테마 × 5개 언어</b><br>
<sub>Cyberpunk, Sakura Pink 등 테마를 원클릭으로 전환</sub>
</td>
<td width="50%" align="center">
<img src="4.gif" width="100%" alt="사고 모드"><br>
<b>원클릭 사고 모드 전환</b><br>
<sub>Qwen3/3.5, DeepSeek 등 추론 모델의 사고 ON/OFF 지원</sub>
</td>
</tr>
</table>
